...
echo "export EDITOR='nano -w'" >> /home/ubuntu/.bashrc 

# # Optionally, download a dataset:
# wget "https://researchdata.ntu.edu.sg/api/access/datafile/68132" |tac | tac | grep -qs foo
